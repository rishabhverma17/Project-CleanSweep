...
public interface IFamilyRepository
{
    ...
    Task<int> GetFamilyAlbumMediaCountAsync(Guid familyId, CancellationToken ct = default);
    ...
    Task<long> GetFamilyAlbumStorageUsageAsync(Guid familyId, CancellationToken ct = default);
